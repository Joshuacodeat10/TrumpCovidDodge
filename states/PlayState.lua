...
function PlayState:update(dt)
    ...
    if self.timer > 7 then
        ...
        local y = math.max(-PIPE_HEIGHT + 10, math.min(self.lastY + math.random(-20,
        50), PIPE_HEIGHT / 3))
        ...
        table.insert(self.pipePairs, {
            ...
            pipes = {
                Pipe('top', y),
                Pipe('bottom',  y + PIPE_HEIGHT + math.random(140,116))
            }
        })
...
function PlayState:render()
    ...
    love.graphics.print('SuperTrump Score: ' .. tostring(self.score), 8, 8)
